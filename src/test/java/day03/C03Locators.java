...
public class C03Locators {
 ...
 By firstFiledId1 = By.id("session_key");
    @BeforeClass
    ...
    public void locatorId(){
       ...
       WebElement firstFiled2 = driver.findElement(firstFiledId1);
       firstField.click();
    ...
    public void locatorClass() throws InterruptedException {
        // we should ovaid using long class names that contains space between them
    ...
    public void locatorTagName() throws InterruptedException {
        ...
        driver.findElement(new By.ByTagName("input"));
    ...
    public void locatorPartialLinkText() throws InterruptedException {
        driver.findElement(By.partialLinkText("User Agreemen")).getText();
    }
