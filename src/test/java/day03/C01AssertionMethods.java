...
public class C01AssertionMethods {
    ...
    public void assertEqualsTest() {
        ...
        //Assert.assertEquals( "The values are not equal ...." , 6,5); //if the teat not passed
    }
    ...
    public void assertNullTest() {
        ...
        Integer a = null;
        //int d = null ; int does not accept null valuse
        String b = "";
    ...
    public void assertSameTest() {
        ...
        String a = "SDA" ;
        String b = "SDA" ; //have same ref
        String c = new String("SDA") ; // have diffrerent add
        String d = new String("SDA") ;
        assertEquals(a,b);
        assertEquals(a,c);
        assertSame(a,b); //passed
        //assertSame(a,c);
